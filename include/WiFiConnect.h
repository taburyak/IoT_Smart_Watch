...
void WiFiConnect::InitialConnect()
{
...
void WiFiConnect::initAPIPConfigStruct(WiFi_AP_IPConfig &in_WM_AP_IPconfig)
{
...
void WiFiConnect::initSTAIPConfigStruct(WiFi_STA_IPConfig &in_WM_STA_IPconfig)
{
...
void WiFiConnect::displayIPConfigStruct(WiFi_STA_IPConfig in_WM_STA_IPconfig)
{
...
void WiFiConnect::configWiFi(WiFi_STA_IPConfig in_WM_STA_IPconfig)
{
  #if USE_CONFIGURABLE_DNS  
...
bool WiFiConnect::loadConfigData()
{
...
void WiFiConnect::saveConfigData()
{
